...
class DatabaseHelper {
  static final DatabaseHelper _instamce = new DatabaseHelper.internal();

  factory DatabaseHelper() => _instamce;
  ...
  Future<int> getCount() async {
    ...
    return Sqflite.firstIntValue(
        await dbClient.rawQuery("SELECT COUNT(*) $tableUser"));
  }
  ...
  Future<int> deleteUser(int id) async {
    var dbClient =  await db;
    return dbClient.delete(tableUser, where: "$columnId = ?",whereArgs: [id]);
  }
